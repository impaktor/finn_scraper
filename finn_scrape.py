...
def main():
    ...
    # Handwaivy: assume we only need to check first N-1 pages, total counter * N adverts
    ...
    for url in urls:
        ...
        # this is the class type that for each advert holds image, title, url, etc.
        ...
        # if next page of hits isn't fully populated, we know we shouldn't keep going:
